...
const bodyMaterial = new THREE.MeshPhysicalMaterial({
  ...
  metalness: 1, //金属度
  roughness: 0.5, //粗糙程度
  clearcoat: 1, //设置清漆,像汽车喷漆的光滑效果
  clearcoatRoughness: 0, //设置清漆粗糙度，想要比较光滑，设置为0
});
...
onMounted(()=>{
  ...
  const dracoLoader = new DRACOLoader(); // 解压缩工具
  dracoLoader.setDecoderPath("./draco/gltf/"); // 设置gltf解压缩工具路径
  loader.setDRACOLoader(dracoLoader); //添加到loader中
  // 解压文件
